...
export class SurfaceSceneTorus extends SurfaceSceneBase {
  constructor(scene: Scene, updateUIFunction: UpdateUIFunction) {
    ...
    const descriptions: string[] = [
      ...
      'Hiding edge 2,5',
      'Rerouting edge 2,5 over horizontal square borders',
      'Hiding edge 1,6',
    ...
    const reorderingSteps: VisualizationStep[] = [
      ...
      { description: descriptions[5], stepNumber: 5, redo: k33RerouteEdge25_HideAffectedEdge, undo: _undoK33RerouteEdge25_HideAffectedEdge },
      { description: descriptions[6], stepNumber: 6, redo: k33RerouteEdge25_RedrawAffectedEdge, undo: _undoK33RerouteEdge25_RedrawAffectedEdge },
    ...
    super(scene, vertexMat, k33Vertices, k33Edges, K33_EDGE_SEGMENTS, reorderingSteps, square, squareCylinderTorus, updateUIFunction, 7, 1, 3, xScale, yScale);
  }
}
