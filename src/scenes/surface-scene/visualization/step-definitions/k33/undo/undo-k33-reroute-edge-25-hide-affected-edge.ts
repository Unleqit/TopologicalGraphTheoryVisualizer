...
export function _undoK33RerouteEdge25_HideAffectedEdge(context: VisualizationContext): void {
  createEdgeRecordsFromEdgeIDs(context.vertices, ['2,5'], context.edgeSegmentCount).forEach((edge) => {
