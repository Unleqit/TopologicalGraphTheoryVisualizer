...
export class PlanarityEmbeddingInteractionController extends PlanaritySceneInteractionController {
  constructor(
  ...
  protected override handleSelection(x: number, y: number): boolean {
    return false;
  }
